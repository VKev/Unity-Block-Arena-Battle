...
namespace PlayerStateMachine
{
    ...
    public class PlayerRunState : BaseState<PlayerStateMachine.EState>
    {
        ...
        public override void EnterState()
        {
            ...
            InputController.JumpAction.AddPerformed(JumpActionPerformed);
        ...
        {
            InputController.JumpAction.RemovePerformed(JumpActionPerformed);
        ...
        {
            if(CurrentSuperState.StateKey == PlayerStateMachine.EState.Grounded && player.rootState.IsGrounded){
                player.rootState.IsJumping = true;
                player.rootState.FloatingHeight = 0f;
            }
        }
